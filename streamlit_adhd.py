...
def create_demo_dataset():
    ...
    # Créer des données aléatoires mais cohérentes
    data = {
    ...
    st.info("ℹ️ Données de démonstration chargées")
    return df
...
def page_machine_learning():
    ...
    try:
        ...
        if df is None:
            st.error("❌ Impossible de charger les données")
            st.info("💡 Veuillez vérifier votre fichier de données ou télécharger un nouveau fichier.")
            return
